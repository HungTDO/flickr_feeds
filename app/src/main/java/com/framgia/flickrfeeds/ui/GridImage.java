...
public class GridImage extends Fragment {
    ...
    public static GridImage newInstance(int numberOfColumns) {
    ...
    private void bindView() {
        ...
        List<Album> listAlbum = AlbumManager.getAlbumList(getActivity());
        adapter = new GridImageAdapter(getActivity(), listAlbum);
